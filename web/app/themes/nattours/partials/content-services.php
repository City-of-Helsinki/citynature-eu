        ...
        <?php foreach( $routes as $route ): ?>
          <a href="<?= get_permalink($route->ID) ?>">
            <div class="link-component">
              <div class="link-component__img" style="background-image: url(<?= get_the_post_thumbnail_url( $route->ID, 'location_thumb' ); ?>); background-color: gray;"></div>
      ...
      <div class="text-content"> 
        ...
        <?php foreach( $services as $service ): ?>
          <a href="<?= get_permalink($service->ID) ?>">
            <div class="link-component">
              <div class="link-component__img" style="background-image: url(<?= get_the_post_thumbnail_url( $service->ID, 'location_thumb' ); ?>); background-color: gray;"></div>
              <div class="link-component__text">
